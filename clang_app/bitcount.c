...
void BitCount() {
    ...
    klee_make_symbolic(&n_0, sizeof(n_0), "n_0");
    klee_make_symbolic(&n_1, sizeof(n_1), "n_1");
    klee_make_symbolic(&n_2, sizeof(n_2), "n_2");
    klee_make_symbolic(&n_3, sizeof(n_3), "n_3");
    klee_make_symbolic(&n_4, sizeof(n_4), "n_4");
    klee_make_symbolic(&n_5, sizeof(n_5), "n_5");
    klee_make_symbolic(&n_6, sizeof(n_6), "n_6");
    //n_0 = 0;
    //n_1 = 0;
    //n_2 = 0;
    //n_3 = 0;
