...
for f in sys.argv[2:]:
    ...
    while line:
        ...
        ######  BR + BRA checks #######
            ...
            if(match.group(2) != "0xfed2" and match.group(2) != "0xfed6" and not checkAddress(match.group(2),bottomInstructionMemory,topInstructionMemory,20)): #BR won't allow more than 16 bits           
