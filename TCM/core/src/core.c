...
__attribute__((section(".tcm:rodata"))) const uint16_t receive_update_address = 0xfed2;

__attribute__((section(".tcm:rodata"))) const uint16_t send_xor_address = 0xfed6;
    ...
    while (address + (count*2) < lastAddress){
        ...
        /****** CALL  *********/
            ...
            if(outcome != REJECTED){
                ...
                if (!cfi && (opCode & 0x003f) == 0x0030 && ((operand1 == safe_mov) || (operand1 == safe_movx) || (operand1 == safe_xor) || (operand1 == safe_xorx) || (operand1 == safe_add) || (operand1 == safe_addx)|| (operand1 == safe_addc) || (operand1 == safe_addcx) || (operand1 == safe_dadd) || (operand1 == safe_daddx) || (operand1 == safe_sub) || (operand1 == safe_subx) || (operand1 == safe_subc)|| (operand1 == safe_subcx) ||)) {
